            ...
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="nama_anggota" name="nama_anggota">
                  <?php echo form_error('nama_anggota', '<div class="text-danger small ml-2">', '</div>') ?>
                </div>
                <div class="form-group">
                ...
                <button style="submit" class="btn btn-primary btn-user btn-block">Register Account</button>
              </form>
              <hr>
              <div class="text-center">
              </div>
