					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="tg-wishlistandcart">
								...
								<button class="tg-btn tg-btnstyletwo tg-active">Login sebagai anggota</button>
								</a>
							</div>
							...
							<nav id="tg-nav" class="tg-nav">
								...
								<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
									<ul>
										...
										<li><a href="<?php base_url() ?>dashboard">Home</a></li>
										<li><a href="<?php base_url() ?>auth">Author</a></li>
									</ul>
								</div>
							</nav>
						</div>
