...
<!-- Nav Item - Dashboard -->
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/data_pengarang') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/data_keluhan') ?>">
          <i class="fas fa-fw fa-user"></i>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <ul class="na navbar-nav navbar-right">
                <?php if($this->session->userdata('username')) { ?>
                  <li><div>Selamat Datang <?php echo $this->session->userdata('nama_anggota') ?></div></li>
